...
class CommentViewSet(viewsets.ModelViewSet):
    ...
    def get_queryset(self):
        return Comment.objects.filter(post_id=self.kwargs['post_pk'], parent_comment=None)
    ...
    def replies(self, request, post_pk=None, pk=None):
        try:
            ...
            return Response({"detail": "Comentário ou post não encontrado."}, status=status.HTTP_404_NOT_FOUND)
